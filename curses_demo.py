...
def demo():
    def drawmenu():
        ...
        while exit == False:
            ...
            stdscr.addstr(4, 5, "Press Q when you finish.", curses.A_BOLD)
    ...
    stdscr.addstr(4, 5, "To do this, make your window fullscreen (doing so will automatically exit this program) and then run this program", curses.A_BOLD)
    stdscr.addstr(5, 5, "again.", curses.A_BOLD)
    stdscr.addstr(7, 5, "Press a key...", curses.A_BLINK)
    stdscr.getch()
    drawbox()
    ...
    stdscr.addstr(5, 5, "(Note that those numbers change accordingly to your window size.", curses.A_BOLD)
    stdscr.addstr(6, 5, "BUT if you change your window size now, the program will exit.)", curses.A_BOLD)
    stdscr.addstr(8, 5, "Press a key...", curses.A_BLINK)
    stdscr.getch()
    drawbox()
    ...
    stdscr.addstr(4, 5, "(Note that I'm not trying to convince you to use it, I know you are already interested lol. This is just a demo to", curses.A_BOLD)
    stdscr.addstr(5, 5, "show off the capabilities!)", curses.A_BOLD)
    stdscr.addstr(7, 5, "Press a key...", curses.A_BLINK)
    stdscr.getch()
    drawbox()
