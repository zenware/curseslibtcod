...
def combat(location, difficulty):
    def loot():
        ...
        if loot >= 1:
            box()
            stdscr.addstr(5, 5, "loot() is being run!")
            stdscr.getch()
        ...
        while True:
            ...
            if selection == 1:
                ...
                if enemyhealth <= 0:
                    ...
                    if earmor != 0:
                        stdscr.addstr(5, 38-len(f"The {enemyname} was wearing a {earmorname}!"))
                        stdscr.refresh()
                        stdscr.getch()
                        ...
                        stdscr.addstr(5, 38-len(f"The {enemyname} was carrying a {eweaponname}!"))
                        stdscr.refresh()
                        stdscr.getch()
